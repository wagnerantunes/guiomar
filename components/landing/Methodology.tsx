...
export function Methodology({ getSetting }: MethodologyProps) {
    ...
    return (
        <section
            id="metodologia"
            className="py-32 px-6 bg-background-dark relative overflow-hidden"
        >
            {/* Ambient Background */}
            <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-primary/5 blur-[120px] rounded-full opacity-20 pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-32 space-y-8">
                    <span className="text-[10px] font-black text-primary uppercase tracking-[0.4em] border border-primary/20 px-4 py-2 rounded-full bg-primary/5 shadow-[0_0_20px_rgba(19,236,91,0.1)]">Como trabalhamos</span>
                    ...
                    {(content.steps || SECTION_DEFAULTS.metodologia.steps).map((m: any, i: number) => (
                        ...
                        >
                            <div className="flex-1 w-full lg:text-right">
                                {i % 2 === 0 && (
                                    <motion.div
                                        ...
                                        className="bg-zinc-900/40 backdrop-blur-xl p-10 rounded-[3rem] border border-white/5 hover:border-primary/30 hover:shadow-[0_0_40px_-10px_rgba(19,236,91,0.15)] transition-all duration-500 group relative overflow-hidden"
                                    >
                            ...
                            <div className="relative z-20 shrink-0">
                                ...
                                <div className="size-20 rounded-2xl bg-background-dark text-primary flex items-center justify-center font-black text-2xl border border-primary/30 shadow-[0_0_30px_rgba(19,236,91,0.2)] relative z-10 rotate-45 group hover:rotate-0 transition-all duration-500">
