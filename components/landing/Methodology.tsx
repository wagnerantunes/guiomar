...
export function Methodology({ getSetting }: MethodologyProps) {
    ...
    return (
        <section
            id="metodologia"
            className="py-32 px-6 bg-background relative overflow-hidden transition-colors duration-500"
        >
            {/* Ambient Background */}
                            ...
                            <div className="flex-1 w-full lg:text-right">
                                {i % 2 === 0 && (
                                    <motion.div
                                        ...
                                        className="bg-card backdrop-blur-xl p-10 rounded-[3rem] border border-border hover:border-primary/30 hover:shadow-[0_0_40px_-10px_rgba(var(--primary-rgb),0.15)] transition-all duration-500 group relative overflow-hidden shadow-2xl"
                                    >
